...
function UI(){
    ...
    UI.prototype.showAllTasks = function(){
      ...
      tasks.forEach((task) => {
        newHtml +=` <div class="task" ${task.isComplete ? "completed": ""}  data-createdat="${task.id}">
    ...
    UI.prototype.editTask = function(e){
      ...
      document.querySelector("#updatedTaskId").value= data.id;
    ...
    const taskId = document.querySelector("#updatedTaskId").value;
   ...
   document.querySelector("#newtaskID").value = "";
   document.querySelector("#updatedTaskId").value= "";
